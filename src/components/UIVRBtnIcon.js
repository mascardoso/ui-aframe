...
//     const elOnlyIcon = data.onlyIcon;
...
//           elDepth
//         ))
//       : (this.geometry = new AFRAME.THREE.CylinderBufferGeometry(0.03, 0.03, 0, 32));
...
//     // Set Text on Button
//     !elOnlyIcon && setButtonText(el, elText, elDepth, elWidth, elTextColor);

//     // Rotate if icon
//     elOnlyIcon && el.setAttribute("rotation", "90 0 0")
//     elOnlyIcon && el.querySelector("a-text[uivricon]").setAttribute("rotation", "-90 0 0")
//     elOnlyIcon && el.querySelector("a-text[uivricon]").setAttribute("position", "0 0.001 0")
//     elOnlyIcon && el.querySelector("a-text[uivricon]").setAttribute("align", "center")
